...
function createArrayByLength(len) {
...
class App extends Component {
  ...
  renderDays = (year, month) => {
    ...
    return days.map(({year, month, date, disabled}, index) => {
      const isToday = this.today.year === year && this.today.month === month && this.today.date === date;
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.footer}>
          <span onClick={this.gotoToday}>回到今天</span>
        </div>
      </div>
    );
  }
